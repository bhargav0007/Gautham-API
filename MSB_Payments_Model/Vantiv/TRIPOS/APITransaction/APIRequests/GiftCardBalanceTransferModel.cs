...
{
    [Serializable]
    public class GiftCardBalanceTransferModel : BaseModel
    {      
        ...
        {
            [Required]
            [JsonPropertyName("alternateCardNumber1")]
            public string AlternateCardNumber1 { get; set; }

            [JsonPropertyName("alternateCardNumber2")]
            public string AlternateCardNumber2 { get; set; }

            [JsonPropertyName("alternateCardNumber3")]
            public string AlternateCardNumber3 { get; set; }
